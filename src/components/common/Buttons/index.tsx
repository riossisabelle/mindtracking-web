...
export default function Button(props: propsButton) {
  ...
  return props.secondary ? (
    // Button secundario
    <button
      className={`${width} ${padding} bg-none border-blue-600 border-[3px]
        md:px-17 md:py-3 rounded-3xl transition-all duration-200 ${mtForSecondary} cursor-pointer
...
`}
    ...
    // Button primario
    <button
      className={`${width} bg-blue-600 hover:bg-blue-500 px-10 py-2 md:px-17 md:py-3 rounded-4xl md:rounded-3xl border-4 border-transparent transition-all duration-200 ${mtForSecondary} cursor-pointer
        disabled:opacity-60 disabled:cursor-not-allowed 
